...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.podcasts_count'
        db.add_column(u'teami18n_country', 'podcasts_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.podcasts_count'
        db.delete_column(u'teami18n_country', 'podcasts_count')
